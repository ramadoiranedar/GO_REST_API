...
func TestCreateCategorySuccess(t *testing.T) {
	...
	request.Header.Add("X-API-Key", "my_key_xxx")
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	tx, _ := db.Begin()
	categoryRepository := repository.NewCategoryRepository(db)
	category := categoryRepository.Create(context.Background(), domain.Category{
		Name: "Gadget",
	})
	tx.Commit()
...
func TestListCategoriesSuccess(t *testing.T) {
	...
	tx, _ := db.Begin()
	categoryRepository := repository.NewCategoryRepository(db)
	category1 := categoryRepository.Create(context.Background(), domain.Category{
		Name: "Gadget",
	})
	category2 := categoryRepository.Create(context.Background(), domain.Category{
		Name: "Computer",
	})
	tx.Commit()
